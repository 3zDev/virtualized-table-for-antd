...
var TableImpl = _react.default.forwardRef(function TableImpl(props, ref) {
...
var RowImpl = _react.default.forwardRef(function RowImpl(props, ref) {
  return _react.default.createElement("tr", Object.assign({
    ref: ref
  }, props));
});
/**
...
function VTable(props, ref) {
  ...
  RAF_update_self = (0, _react.useCallback)(function (timestamp) {
    if (ctx.vt_state !== e_VT_STATE.RUNNING) return;
    var evq = event_queue;
  ...
  }, _react.default.createElement(Table, Object.assign({}, rest, {
    style: rest_style
  }))));
}
...
function VWrapper(props) {
  ...
  if (!Array.isArray(rows)) {
    ...
    return _react.default.createElement(Wrapper, Object.assign({}, restProps), measureRow, rows);
  }
  ...
  return _react.default.createElement(Wrapper, Object.assign({}, restProps), measureRow, trs);
}

function VTRow(props) {
  var inst = _react.default.createRef();
  ...
  if (!Array.isArray(children)) {
    ...
    return _react.default.createElement(Row, Object.assign({}, rest), children);
  }
  ...
  return _react.default.createElement(Row, Object.assign({}, rest, {
    ref: inst
  }));
}
...
function init(fnOpts, deps) {
  var ctx = (0, _react.useRef)(_react.default.createContext({})).current;
  ...
  (0, _react.useMemo)(function () {
    var VTable2 = _react.default.forwardRef(VTable); // set the virtual layer.


    ctx_value._vtcomponents = {
      table: function table(props) {
        return _react.default.createElement(VTable2, Object.assign({}, props, {
          context: ctx,
          ref: ctx_value.ref
        }));
      },
      body: {
        wrapper: function wrapper(props) {
          return _react.default.createElement(ctx.Consumer, null, function ()
          /* value */
          {
            return _react.default.createElement(VWrapper, Object.assign({}, props, {
              ctx: ctx_value
            }));
          });
        },
        row: function row(props) {
          return _react.default.createElement(VTRow, Object.assign({}, props, {
            context: ctx_value
          }));
        }
      }
